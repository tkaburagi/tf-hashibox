...
cd /opt/wetty && sudo npm install -g wetty
...
echo "--> Enabling HTTPS"
cd /opt/wetty && sudo openssl req -x509 -newkey rsa:2048 -keyout key.pem -out cert.pem -days 30000 -nodes \-subj "/C=US/ST=California/L=SF/O=Training/CN=www.hashitraining.com"
