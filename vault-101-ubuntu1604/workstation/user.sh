...
sudo mkdir -p /home/${training_username}/.vim/autoload /home/${training_username}/.vim/bundle
sudo curl -LSso /home/${training_username}/.vim/autoload/pathogen.vim https://tpo.pe/pathogen.vim
sudo tee -a "/home/${training_username}/.vimrc" > /dev/null <<"EOF"
...
# Terraform plugin
sudo git clone https://github.com/hashivim/vim-terraform.git /home/${training_username}/.vim/bundle/vim-terraform
# Airline plugin for vim statusbar
sudo git clone https://github.com/vim-airline/vim-airline /home/${training_username}/.vim/bundle/vim-airline
sudo chown -R ${training_username}:${training_username} /home/${training_username}/.vim*


# Setting sudo access to no password
sudo sed -i "s/%sudo\sALL=(ALL:ALL) ALL/%sudo ALL=(ALL:ALL) NOPASSWD:ALL/" /etc/sudoers
